...
Page({
  ...
  //       if (res.confirm) {
  //         content.icon_type = "success";
  //       } else if (res.cancel) {
  //         console.log('用户点击取消')
  //       }
  //       console.log(content.icon_type)
  //       var set = 'Target['+content.id+'].icon_type';
  //       this.setData({
  //         'set':content.icon_type
  //       })
  //     }
  //   })
  //   // var set = 'Target['+content.id+'].icon_type';
  ...
  //   //   'set':content.icon_type
  //   // })
  //   // console.log(this.data.Target[content.id].icon_type)
  // }
})